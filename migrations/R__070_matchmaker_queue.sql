...
INSERT INTO `matchmaker_queue` (id, technical_name, featured_mod_id, leaderboard_id, name_key, team_size, params, enabled, veto_tokens_count) VALUES
(1,'ladder1v1',0,2,'matchmaker_queue.ladder1v1',1,NULL,1,0),
(2,'tmm2v2',0,3,'matchmaker_queue.tmm2v2.name',2,NULL,1,0),
(3,'tmm4v4_full_share',0,4,'matchmaker_queue.tmm4v4_full_share.name',4,NULL,1,0),
(4,'tmm4v4_share_until_death',0,5,'matchmaker_queue.tmm4v4_share_until_death.name',4,'{"GameOptions":{"Share":"ShareUntilDeath"}}',0,0),
(5,'tmm3v3',0,6,'matchmaker_queue.tmm3v3.name',3,NULL,1,0)
...
ON DUPLICATE KEY UPDATE
    ...
    veto_tokens_count=COALESCE(veto_tokens_count, VALUES(veto_tokens_count));
