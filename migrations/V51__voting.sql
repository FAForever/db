CREATE TABLE IF NOT EXISTS voting_subject (
  ...
  `reveal_winner`      TINYINT UNSIGNED NOT NULL DEFAULT 0
  COMMENT 'When set to true after voting ended the winner is calculated and shown publicly',
...
CREATE TABLE IF NOT EXISTS voting_choice (
  `id`                 INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS winner_for_voting_question (
  `voting_question_id` INT UNSIGNED NOT NULL,
