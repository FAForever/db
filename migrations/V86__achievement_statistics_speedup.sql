DROP VIEW `achievement_statistics`;

CREATE TABLE IF NOT EXISTS `achievement_statistics` (
    achievement_id VARCHAR(36) PRIMARY KEY,
    unlockers_count BIGINT,
    unlockers_percent DECIMAL(26,2),
    unlockers_min_duration BIGINT,
    unlockers_avg_duration DECIMAL(21,0),
    unlockers_max_duration BIGINT
) ENGINE=InnoDB;
...
COMMENT 'Recompute the achievement_statistics table every minute'
DO
    BEGIN
        INSERT INTO achievement_statistics
        SELECT
